...
class contratacionesController extends Controller
{
    public function store(Request $request){
        $Contrato = request(['id_paquete','nombre_paquete','id_cliente','nombre_cliente','Tipo_evento', 'Forma_de_pago', 'Fecha', 'Hora', 'Lugar','fecha_contrato','correo','correo_cliente','numero_telefono','id_proveedor']);
