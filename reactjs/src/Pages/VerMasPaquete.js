      ...
      <div className="product d-flex justify-content-center">
        <div className="col-sm-10 p-3 post-container-p">
          ...
          <div className="card p-2 paquete-post-p d-flex flex-row shadow">
            ...
            <div className="paquete-info-container-p ms-2">
              <div className="card p-4 paquete-info-p" style={{borderRadius: '0'}}>
                {paquete != null ? (
                    <div className="info-paquete" style={{marginBottom: '10px'}}>
                      <h1 className="vendor-title">{paquete.name}</h1>
                      <h5 id="proveedorName" style={{ color: "gray" }} className='vendor-name'>...</h5>
                      <h6 style={{ color: "gray" }}>Num. {paquete.id}</h6>
                      <div className="vendor-desc-container" style={{overflowY: 'auto', maxHeight: '285px', marginBottom: '10px'}}>
          ...
          <div className="card col-sm-6 shadow p-2 mb-4 audio-container">
            <audio src={audio} className="audio-control" controls="controls"  preload="none"></audio>
          </div>
        </div>
      </div>
    </div>
